      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <button className="flex items-center gap-3 px-3 py-2 hover:bg-accent rounded-lg transition-colors">
          <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center">
            <span className="text-white text-sm">RK</span>
          </div>
          <div className="text-left hidden lg:block">
            <div className="text-sm text-foreground">Adv. Rajesh Kumar</div>
            <div className="text-xs text-muted-foreground">Delhi HC</div>
          </div>
