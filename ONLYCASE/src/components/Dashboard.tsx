...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  const handleCaseClick = (case_: typeof recentCases[0]) => {
            ...
            <div className="space-y-3">
              {recentCases.map((case_) => (
                <div
                  ...
                  className="p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-sm hover:scale-[1.02] transition-all cursor-pointer"
                >
